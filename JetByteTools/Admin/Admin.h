...
#define JETBYTE_LATEST_TESTED_COMPILER_VERSION 1900
...
#error JETBYTE_DATAGRAM_SOCKETS_SKIP_COMPLETION_PORT_ON_SUCCESS should not be defined by YOU it's internal, define JETBYTE_PERF_DATAGRAM_SOCKETS_SKIP_COMPLETION_PORT_ON_SUCCESS instead
#endif
...
#else
#define JETBYTE_STREAM_SOCKETS_SKIP_EVENT_ON_HANDLE               0
#define JETBYTE_STREAM_SOCKETS_SKIP_COMPLETION_PORT_ON_SUCCESS    0
#define JETBYTE_DATAGRAM_SOCKETS_SKIP_EVENT_ON_HANDLE             0
#define JETBYTE_DATAGRAM_SOCKETS_SKIP_COMPLETION_PORT_ON_SUCCESS  0
#define JETBYTE_FILE_WRITER_SKIP_EVENT_ON_HANDLE                  0
#define JETBYTE_FILE_WRITER_SKIP_COMPLETION_PORT_ON_SUCCESS       0
#define JETBYTE_FILE_READER_SKIP_EVENT_ON_HANDLE                  0
#define JETBYTE_FILE_READER_SKIP_COMPLETION_PORT_ON_SUCCESS       0
#define JETBYTE_STREAM_SOCKETS_SKIP_MARSHAL_TO_IO_POOL            0
#define JETBYTE_DATAGRAM_SOCKETS_SKIP_MARSHAL_TO_IO_POOL          0
...
#error ENABLE_SOCKET_IDENTIFIERS must be 1 if JETBYTE_TRACE_STREAM_SOCKET_INTERNAL_ABORTS is enabled
...
#error ENABLE_SOCKET_IDENTIFIERS must be 1 if JETBYTE_TRACE_FLOW_CONTROL_TO_DEBUG_LOG is enabled
#endif
#endif
#endif
