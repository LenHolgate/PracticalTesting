...
#define THROW_ON_NO_EXCEPTION_FROM_CTOR_EX(e) do{try{e;throw JetByteTools::Test::CTestException(_T("No Exception from: ") _T(#e) _T("()"));}catch (JetByteTools::Test::CTestException &){throw;}catch (JetByteTools::Win32::CSEHException &){throw;}catch (...){}}while(0)
